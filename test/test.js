...
describe('PhotoImport', function() {
  ...
  //     return PhotoImport.readExif(`${sourceFileFolder}/iphone_photo.jpg`)
  //     .then(function(tags) {
  //       assert.equal(PhotoImport.getFolderDate(tags), '2017-11')
  //     })
  //   })
  ...
  describe('#processFolder()', function() {
    ...
    it('should have created a duplicates folder in the source folder', function() {
      assert.ok(fs.existsSync(`${sourceFileFolder}/duplicates`))
    }) 
